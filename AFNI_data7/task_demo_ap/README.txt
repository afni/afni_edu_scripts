This tree is an updated form of AFNI_data6.
   ...
   do_12_fs.tcsh              - script : FS's recon-all (was run)
   do_13_ssw.tcsh             - script : skullstrip and warp anat (was run)
   do_14_timing.tcsh          - script : convert TSV to AFNI timing (was run)
